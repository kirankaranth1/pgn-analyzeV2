...
0. **[Preprocessing Pipeline](./00-preprocessing-pipeline.md)** - Complete flow before classification
   - Parse PGN to state tree
   - Engine analysis (cloud + local)
   - Node extraction and preparation
   - Re-implementation guide for other languages

1. **[Core Concepts](./01-core-concepts.md)** - Fundamental concepts
...
┌─────────────────────────────────────────────────────────────┐
│                      Game Analysis Input                     │
│                    (PGN String + Initial FEN)                │
└───────────────────────────┬─────────────────────────────────┘
                            │
                            ▼
┌─────────────────────────────────────────────────────────────┐
│                    Parse PGN to State Tree                   │
│  • Convert moves to positions (FEN)                         │
│  • Build tree structure with variations                     │
